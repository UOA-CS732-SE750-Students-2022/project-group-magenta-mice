...
proto.Sim.Protocol.InsertOrderRequest.deserializeBinaryFromReader = function (
  ...
  while (reader.nextField()) {
    ...
    switch (field) {
      ...
      case 3:
        var value =
          /** @type {!proto.Sim.Protocol.InsertOrderRequest.Lifespan} */ (
            reader.readEnum()
          );
        msg.setLifespan(value);
        break;
      case 4:
        var value = /** @type {!proto.Sim.Protocol.InsertOrderRequest.Side} */ (
          reader.readEnum()
        );
        msg.setSide(value);
        break;
...
proto.Sim.Protocol.InsertOrderRequest.prototype.getLifespan = function () {
  return /** @type {!proto.Sim.Protocol.InsertOrderRequest.Lifespan} */ (
...
proto.Sim.Protocol.InsertOrderRequest.prototype.getSide = function () {
  return /** @type {!proto.Sim.Protocol.InsertOrderRequest.Side} */ (
