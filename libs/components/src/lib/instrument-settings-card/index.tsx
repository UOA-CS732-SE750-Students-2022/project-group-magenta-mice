  ...
  if (!isAddCard) {
    return (
      <div className="w-full">
        ...
        <div
          className="h-24 w-full cursor-pointer rounded-lg bg-zinc-700 p-4 transition-all hover:brightness-110"
    ...
    return (
      <div className="w-full">
        <div
          className="flex h-24 w-full cursor-pointer items-center rounded-lg border-2 border-dashed bg-transparent transition-all hover:bg-zinc-800"
          onClick={onClick}
        >
